...
#list = "" # Safety
list = '54edae1454' # RG Daily Digest list
subject = "RG Opinion: *|DATE:l, F j, Y|*"
title = "RG Opinion: {0}".format(date)
folder = 'b853971b56'
...
url = 'http://registerguard.com/csp/cms/rg/pages/newsletters/opinion.csp'
